...
void Search414::BeforeCompute(unsigned upperLimit)
{
	...
	// Так как последний коэффициент правой части всегда кратен 10 и мы ищем уменьшенное в 10
	// раз значение этого коэффициента, то имеет смысл проинициализировать лишь 1/10 значений
	// хеш-таблицы. Это уменьшит количество коллизий и немного увеличит скорость работы
	InitHashTable(m_Hashes, upperLimit / 10);
