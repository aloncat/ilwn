...
// начиная с текущей позиции. Параметр level задаёт степень сжатия от 0 до 5, где 0 соответствует
// отсутствию сжатия, 1 - самому слабому (быстрому), а 5 - самому сильному (медленному) сжатию
bool CompressFile(util::File& src, util::File& dst, int level = 3);
