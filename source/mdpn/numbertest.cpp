...
// Результаты тестирования, 7 января 2021 года (Intel Core i5-10400F 4.1GHz, TurboBoost включен):
//   Цифр   100K   200K    300K    500K       1M
//   x86    1.5s   5.8s   13.0s   36.4s   2m 27s
//   x64    1.4s   5.8s   13.0s   36.4s   2m 26s
...
// на проверку всех этих чисел, а также среднее время одной операции RAA. Тестирование, проведённое 5 декабря
// 2021 года (Intel Core i5-10400F 4.1GHz, TurboBoost включен), показало следующие результаты:
//   x86: best=40.367 ms, av=40.921 ms, av/step=20.482 ns
//   x64: best=33.456 ms, av=33.876 ms, av/step=16.958 ns
