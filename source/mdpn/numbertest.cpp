...
// на проверку всех этих чисел, а также среднее время одной операции RAA. Тестирование, проведённое 7 января
// 2021 года (Intel Core i5-10400F 4.1GHz, TurboBoost включен), показало следующие результаты:
//   x86: best=44.092 ms, av=45.036 ms, av/step=22.541 ns
//   x64: best=36.489 ms, av=37.085 ms, av/step=18.562 ns
