...
public:
	...
	// Если maxCompression == true, то файл будет сохранён с максимальным сжатием (только если
	// есть несохранённые изменения или предудущее сохранение делалось с обычным сжатием)
